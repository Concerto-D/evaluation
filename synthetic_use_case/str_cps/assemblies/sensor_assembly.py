...
from synthetic_use_case.str_cps.assemblies.sensor import Sensor


class SensorAssembly(Assembly):
    def __init__(self, reconf_config_dict, waiting_rate, version_concerto_d, reconfiguration_name, nb_concerto_nodes, scaling_num):
        ...
        remote_assemblies = [f"listener{scaling_num}"]

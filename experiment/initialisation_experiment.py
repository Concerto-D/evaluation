...
def main():
    ...
    uptimes_dir_path_list = [
        ...
        ("inventory.yaml", "concerto-decentralized/inventory.yaml"),
        ("inventory.yaml", "concerto-decentralized-synchrone/inventory.yaml"),
    ]
    for src, dst in uptimes_dir_path_list:
        concerto_d_g5k.put_file(deployment_node["deployment"], src, dst)
